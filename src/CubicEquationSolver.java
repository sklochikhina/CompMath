...
public class CubicEquationSolver {
    ...
    private ArrayList<Double> cubic_roots;
    ...
    private void threeRoots() {
        if (fx1 > epsilon && fx2 < -epsilon) {
            ...
            intervalFromX2();                           // (x2, +inf)
            intervalUpToX1();                           // (-inf, x1)
